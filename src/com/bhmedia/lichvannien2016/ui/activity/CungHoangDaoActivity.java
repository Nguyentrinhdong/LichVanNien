...
@SuppressLint("NewApi")
public class CungHoangDaoActivity extends FragmentActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		DataNew1DataBaseHelper vanTrinhNamDataBaseHelper = new DataNew1DataBaseHelper(
				this);
		Bundle mBundle = getIntent().getExtras().getBundle("Bundle");
		if (mBundle != null) {
			String cunghd = mBundle.getString("IDCHD");
			tv_title.setText(cunghd);
			String thang = mBundle.getString("IDTHANG");
			Category listVanTrinhNam = vanTrinhNamDataBaseHelper.getAllLabelct(this, thang, cunghd);
			// if (nameSinhIt<1920&&nameSinhIt>2014) {
			// AlertDialog alertDialog = new AlertDialog.Builder(
			// KetQuaTVNSActivity.this)
			// .setCancelable(false)
			// .setMessage(
			// "Nội dung bạn cần xem chưa có, bạn vui lòng chọn lại dữ liệu khác.")
