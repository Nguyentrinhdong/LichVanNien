...
@SuppressLint("NewApi")
public class KQCHDActivity extends FragmentActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		InputStream is = null;
		try {
			String chuoi=CungHoangDao2Fragment.idchd+".html";
	...
	public void onClick(View v) {
		...
		case R.id.imageView1:
			...
			;
			String subject = CungHoangDao2Fragment.idchd+" - "+"Western Astrology - Chinese Calendar 2016 - BHMedia Android";
			...
			Intent openInChooser = Intent.createChooser(emailIntent, "Share with");
