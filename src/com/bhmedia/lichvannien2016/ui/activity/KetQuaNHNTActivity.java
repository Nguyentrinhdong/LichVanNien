...
import com.bhmedia.lichvannien2016.ui.fragment.NguHanhNgayTotFragment;
...
@SuppressLint("NewApi")
public class KetQuaNHNTActivity extends FragmentActivity implements
		View.OnClickListener {

	WebView wv_ketqua_nhnt;
...
//				+ "</font></body></html>";
		...
		wv_ketqua_nhnt.getResources().getDimensionPixelSize(
				R.dimen.text_size_large);
		wv_ketqua_nhnt.loadDataWithBaseURL(null, NguHanhNgayTotFragment.thongtin, "text/html", "utf-8",
				null);
	...
	public void onClick(View v) {
		...
		case R.id.iv_share:
			// -----------------------Send có lựa chọn------------------//
						...
						String shareBody = String.valueOf(Html.fromHtml(NguHanhNgayTotFragment.thongtin))+ "\n\n"
