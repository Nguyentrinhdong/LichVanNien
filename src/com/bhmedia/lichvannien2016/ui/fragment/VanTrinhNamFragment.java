...
import com.bhmedia.lichvannien2016.ui.activity.KetQuaVanTrinhNamActivity;
 ...
 */
public class VanTrinhNamFragment extends BaseFragment {
	Context context;
	...
	ImageView iv_ketqua_vantrinhnam;
	String years[], days[];
	...
	protected int getLayoutId() {
		...
		return R.layout.layout_fragment_vantrinhnam;
	}
	...
	protected void onInitializeView(Bundle savedInstanceState) {
		...
		MyApp.tracker().setScreenName("Van Trinh Nam Android");
		MyApp.tracker().send(new HitBuilders.AppViewBuilder().build());

		iv_ketqua_vantrinhnam = (ImageView) findViewById(R.id.iv_ketqua_vantrinhnam);
		iv_ketqua_vantrinhnam.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				...
				Intent intent = new Intent(getActivity(),
						KetQuaVanTrinhNamActivity.class);
		...
		day = (WheelView) findViewById(R.id.day_vtn);
		month = (WheelView) findViewById(R.id.month_vtn);
		year = (WheelView) findViewById(R.id.year_vtn);
